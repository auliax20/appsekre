<template>
  <ul class="menu-nav">
    ...
    <li class="menu-section">
      <h4 class="menu-text">Master Aplikasi</h4>
    ...
    <li
      ...
      v-bind:class="{ 'menu-item-open': hasActiveChildren('/organisasi') }"
    >
        ...
        <ul class="menu-subnav">
          <li aria-haspopup="true" class="menu-item menu-item-parent">
            <span class="menu-link">
              <span class="menu-text">Master Organisasi</span>
            </span>
          </li>
          <router-link
            to="/organisasi/master"
            v-slot="{ href, navigate, isActive, isExactActive }"
          >
            <li
              aria-haspopup="true"
          ...
          <li aria-haspopup="true" class="menu-item menu-item-parent">
            <span class="menu-link">
              <span class="menu-text">Tambah Organisasi</span>
            </span>
          </li>
          <router-link
            to="/organisasi/tambah"
            v-slot="{ href, navigate, isActive, isExactActive }"
          >
            <li
              aria-haspopup="true"
    ...
    <li
      ...
      data-menu-toggle="hover"
      class="menu-item menu-item-submenu"
      v-bind:class="{ 'menu-item-open': hasActiveChildren('/bidang') }"
    >
      <a href="#" class="menu-link menu-toggle">
        <i class="menu-icon flaticon-home"></i>
      ...
      <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
          <li aria-haspopup="true" class="menu-item menu-item-parent">
            <span class="menu-link">
              <span class="menu-text">Master Bidang</span>
            </span>
          </li>
          <router-link
            to="/bidang/master"
          ...
          <li aria-haspopup="true" class="menu-item menu-item-parent">
            <span class="menu-link">
              <span class="menu-text">Tambah Bidang</span>
            </span>
          </li>
          <router-link
            to="/bidang/tambah"
    ...
    <li
      ...
      data-menu-toggle="hover"
      class="menu-item menu-item-submenu"
      v-bind:class="{ 'menu-item-open': hasActiveChildren('/kepegawaian') }"
    >
      <a href="#" class="menu-link menu-toggle">
      ...
      <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
          <li aria-haspopup="true" class="menu-item menu-item-parent">
            <span class="menu-link">
              <span class="menu-text">Master Kepegawaian</span>
            </span>
          </li>
          <router-link
            to="/kepegawaian/master"
            v-slot="{ href, navigate, isActive, isExactActive }"
          >
            <li
              aria-haspopup="true"
    ...
    <li class="menu-section">
      <h4 class="menu-text">Aplikasi</h4>
      <i class="menu-icon flaticon-more-v2"></i>
    </li>
    ...
    <li aria-haspopup="true" data-menu-toggle="hover" class="menu-item">
      <a href="#/suratkeluar" class="menu-link">
        <i class="menu-icon flaticon-mail-1"></i>
        <span class="menu-text">Surat Keluar</span>
      </a>
    </li>
    <li aria-haspopup="true" data-menu-toggle="hover" class="menu-item">
      <a href="#/suratkeluar" class="menu-link">
        <i class="menu-icon flaticon-envelope"></i>
        <span class="menu-text">Surat Perintah Tugas</span>
      </a>
    </li>
    <li class="menu-section">
