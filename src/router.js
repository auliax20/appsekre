  ...
  routes: [
    {
      ...
      children: [
        ...
        {
          path: "/organisasi",
          redirect: "/organisasi/master",
          component: () => import("@/view/pages/organisasi/Organisasi.vue"),
          children: [
            {
              path: "/organisasi/master",
              name: "masterOrganisasi",
              component: () => import("@/view/pages/organisasi/Master.vue")
            },
            {
              path: "/organisasi/tambah",
              name: "tambahOrganisasi",
              component: () => import("@/view/pages/organisasi/Tambah.vue")
            }
          ]
        },
        {
          path: "/bidang",
          redirect: "/bidang/master",
          component: () => import("@/view/pages/bidang/Bidang.vue"),
          children: [
            {
              path: "/bidang/master",
              name: "masterBidang",
              component: () => import("@/view/pages/bidang/Master.vue")
            },
            {
              path: "/bidang/tambah",
              name: "tambahBidang",
              component: () => import("@/view/pages/bidang/Tambah.vue")
            }
          ]
        },
        {
          path: "/kepegawaian",
          redirect: "/kepegawaian/master",
          component: () => import("@/view/pages/kepegawaian/Kepegawaian.vue"),
          children: [
            {
              path: "/kepegawaian/master",
              name: "masterKepegawaian",
              component: () => import("@/view/pages/kepegawaian/Master.vue")
            },
            {
              path: "/kepegawaian/tambah",
              name: "tambahPegawai",
              component: () => import("@/view/pages/kepegawaian/Tambah.vue")
            }
          ]
        },
        {
